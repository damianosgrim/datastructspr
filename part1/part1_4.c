...
int BISbest(data data[], int date,int s)  {
    ...
    while (date != data[next].date) {
        ...
        if (date >= data[next].date) {
            ...
            while (date > data[next + pow(2, i-1)((int) sqrt(size))].date) {

                i=2*i;

           }

            right = next + pow(2, j-1)((int)sqrt(size));

            left  = next + pow(2, i)((int) sqrt(size));

        }

       else if (date < data[next *pow(2, i)((int) sqrt(size))].date) {
